export const Testimonials = () => {
    return (
        <section className='my-20'>
            <h1 className="text-2xl text-center font-semibold dark:text-slate-100 mb-5 underline underline-offset-8">Student About CW E-Store</h1>    
            <div className="grid mb-8 rounded-lg border border-gray-200 shadow-xs dark:border-gray-700 md:mb-12 md:grid-cols-2">
