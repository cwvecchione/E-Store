...
export const Search = ({setSearchSection}) => {
  Search.propTypes = {
    setSearchSection: PropTypes.func.isRequired,
  };
  ...
  return (
    <div className="mx-auto max-w-(--breakpoint-xl) p-2 my-5">
        <form onSubmit={handleSearch} className="flex items-center">   
            ...
            <button type="submit" className="bi bi-search py-2.5 px-3 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-hidden focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            </button>
        </form>
    </div>
  )
